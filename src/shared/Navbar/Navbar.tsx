...
export default function Navbar() {
          ...
          return (
                    <div className="hidden md:flex navbar glass sticky top-0 z-50 md:px-16 lg:px-32">
                              <div className="navbar-start">
                                        ...
                                        <Link to="/" className="btn bg-transparent hover:bg-transparent border-none text-black normal-case text-xl flex justify-center items-center gap-2"> <img src={Logo} alt="" className='w-8 md:w-10' /> BTEB Results Factory</Link>
                              </div>
